...
exports.SubscriptionPlanOutput = void 0;
const SubscriptionPlanOutput = () => ({
    plans: {
        Free: {
            price: "0$/month",
            options: {
...
exports.SubscriptionPlanOutput = SubscriptionPlanOutput;
//# sourceMappingURL=subscription-plan-output.constant.js.map